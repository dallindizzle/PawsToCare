...
<div class="container">
    <h1 class="my-4 text-center">Dogs</h1>
    ...
    <table class="table table-bordered table-hover">
        ...
        <tr>
            ...
            <td><input type="text" class="form-control" id="licFilter" placeholder="Filter"></td>
            ...
            <td><input type="text" class="form-control" id="weightFilter" placeholder="Filter"></td>
            <td><input type="text" class="form-control" id="" placeholder="" disabled></td>
            <td><input type="text" class="form-control" id="" placeholder="" disabled></td>
        </tr>
        <tr id="headers">
            <th scope="col" title="Name of the dog" id="Name" class="clickable">Name</th>
